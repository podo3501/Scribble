...
void CDummy::CreateInstanceData(CMaterial* material, const std::string& geoName, const std::string& meshName)
{
	...
	m_instances[geoName][meshName] = std::move(instances);
}

InstanceDataList CDummy::GetInstanceDummyData(const std::string& geoName, const std::string& meshName)
{
